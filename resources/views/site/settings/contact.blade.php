                    ...
                    <div class="my-4 col-lg-5 mt-5">
                        <div class="contact-content pb-5">
                            ...
                            <ul class="social-icons social-icons-styled social--icons-styled pt-30px">
                                    @if(!empty($telegram))
                                    <li>
                                        <a href="{{ $telegram }}"><i class="la la-facebook"></i></a>
                                    </li>
                                   @endif
                                    @if(!empty($twitter))
                                    <li>
                                        <a href="{{ $twitter }}"><i class="la la-twitter"></i></a>
                                    </li>
                                    @endif
                                    @if(!empty($instagram))
                                    <li>
                                        <a href="{{ $instagram }}"><i class="la la-instagram"></i></a>
                                    </li>
                                    @endif
                                    @if(!empty($youtube))
                                    <li>
                                        <a href="{{ $youtube }}"><i class="la la-youtube"></i></a>
                                    </li>
                                    @endif
                            </ul>
                        </div>
