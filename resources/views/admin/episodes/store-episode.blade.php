<div>
    ...
    <div class="card card-custom gutter-b example example-compact">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <x-admin.forms.checkbox value="1" id="can_homework"  label="امکان بارگذاری تمرین " wire:model.defer="can_homework" />
                <x-admin.forms.dropdown id="homework_storage" :data="$data['storage']" label="  فضای ذخیره سازی تمرین" wire:model.defer="homework_storage"/>
    ...
    <x-admin.modal-page id="homework" title="تمرین" wire:click="storeHomework">
        ...
        <div class="col-12">
            <x-admin.forms.text-area disabled label=" توضیحات کاربر" wire:model.defer="h_description" id="h_description" />
            ...
            <x-admin.form-section  label="نتیجه">
                ...
                <x-admin.forms.input max="5" min="1" type="number" help="از 1 تا 5" id="h_score" label="امتیاز *" wire:model.defer="h_score"/>
            </x-admin.form-section>
        </div>
    </x-admin.modal-page>
</div>
