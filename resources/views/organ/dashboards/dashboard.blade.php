<div>
    ...
    <x-organ.form-control  :store="false"  title="داشبورد"/>
        ...
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-center justify-content-between">
                    <x-organ.forms.jdate-picker id="date" label=""   wire:model.defer="from_date_view"/>
                </div>
                <p class="m-0">تا تاریخ</p>
                <div>
                    <x-organ.forms.jdate-picker id="date2" label=""  wire:model.defer="to_date_viwe"/>
                </div>
                <div>
            ...
            <div class="row">
                <div class="col-lg-12 table-responsive">
                    <h4 class="card-label">
                        <span class="d-block text-dark font-weight-bolder">اموزشگاه ها و مدریسن</span>
                    </h4>
                    <table  class="table table-striped table-bordered" id="kt_datatable">
                        ...
                        <tr>
                            <th>#</th>
                            <th>شماره شناسه</th>
                            <th>عنوان اموزشگاه</th>
                            <th>تاریخ تایسیس</th>
                            <th>مدریسین</th>
                        </tr>
                        </thead>
                        <tbody>
                        @forelse(auth()->user()->organs as $item)
                            <tr>
