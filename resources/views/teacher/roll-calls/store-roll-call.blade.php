<div>
    ...
    <x-teacher.form-control store="{{false}}" mode="{{$mode}}" title="حضور غیاب" />
    <div class="card card-custom gutter-b example example-compact">
        ...
        <div class="card-body">
            <x-teacher.forms.select2 id="chapter" :data="$data['chapter']" label=" فصل" wire:model="chapter" />
            ...
            {{$details->links('teacher.layouts.paginate')}}
        </div>
    </div>
</div>
