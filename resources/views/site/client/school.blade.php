...
">
    <div class="d-inline align-items-center align-content-center" style="
    ">
        <button wire:click="start" {{ $hasStarted ? "disabled" : "" }}
                class="btn btn-primary" >
            {{ ! $hasStarted ? "شروع آموزشگاه" : "آموزشکاه شما فعال می باشد" }}
        </button>
