<div>
    ...
    <x-organ.form-control link="{{ route('organ.store.episodes',['create'] ) }}" confirmContent="تعریف درس جدید"  title="درس ها "/>
    <div class="card card-custom">
        <div class="card-body">
                        ...
                        <table  class="table table-striped table-bordered" id="kt_datatable">
                            ...
                            @forelse($episodes as $item)
                                <tr>
                                    ...
                                    <td>
                                        <x-admin.edit-btn href="{{ route('organ.store.episodes',['edit', $item->id]) }}" />
                                    </td>
                                </tr>
                            @empty
            ...
            @endif
            {{$episodes->links('organ.layouts.paginate')}}
        </div>
    </div>
