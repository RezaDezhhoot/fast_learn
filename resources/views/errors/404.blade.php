        ...
        <div class="col-lg-7 mx-auto">
            <div class="error-content text-center">
                ...
                <div class="section-heading">
                    <h3 class="section__title pb-3">اوف این صفحه وجود ندارد</h3>
                    <p class="section__desc">
                        به نظر می رسد ما نمی توانیم صفحه مورد نظر شما را پیدا کنیم، پیوندی که دنبال کرده اید ممکن است خراب شده باشد، به طور موقت در دسترس نیست. یا به نظر می رسد آدرس وب سایتی که وارد کرده اید نادرست بوده است.
                    </p>
                </div>
