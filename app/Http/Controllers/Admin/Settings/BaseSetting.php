    ...
    public function store()
    {
        ...
        $this->validate(
            [
                ...
                'auth_type' => ['required','in:otp,email'],
            ...
            [
                ...
                'sftp_root' => 'sftp root',
                'sftp_privateKey' => 'sftp privateKey',
                'sftp_hostFingerprint' => 'sftp hostFingerprint',
                'sftp_maxTries' => 'sftp maxTries',
                'sftp_port' => 'sftp port',
                'sftp_passphrase' => 'sftp passphrase',
                'sftp_host' => 'sftp host',
                'sftp_username' => 'sftp username',
                'sftp_password' => 'sftp password',
                'sftp_useAgent' => 'sftp useAgent',
                'sftp_available' => 'فعال سازی',

                'zarin_merchantId' => 'شناسه درگاه',
                'zarin_mode' => 'zarin mode',
                'zarin_logo' => 'لوگو درگاه',
                'zarin_unit' => 'واحد درگاه',
                'payir_merchantId' => 'شناسه درگاه',
                'payir_logo' => 'لوگو درگاه',
                'payir_unit' => 'واحد درگاه',
                'idpay_logo' => 'لوگو درگاه',
                'idpay_merchantId' => 'شناسه درگاه',
                'idpay_sandbox' => 'idpay sandbox',
                'idpay_unit' => 'واحد درگاه',
