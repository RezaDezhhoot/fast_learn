<div>
    ...
    <div class="container-fluid">
        <div class="dashboard-heading mb-5">
            <h3 class="fs-22 font-weight-semi-bold">نظر سنچی دوره {{ $course->title }}</h3>
        </div>
        <div style="overflow-x:auto;" class="dashboard-cards mb-5">
            <livewire:site.forms.form id="{{$course->form_id}}" loadHead="1" :course="$course" :form_key="$course->slug" />
        </div>
    </div>
</div>
