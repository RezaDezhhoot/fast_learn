                ...
                <table class="table generic-table">
                    ...
                    @foreach($cartContent as $item)
                        <tr>
                            ...
                            <td>
                                <button wire:click="deleteItem({{$item->id}})" type="button" class="icon-element icon-element-xs shadow-sm border-0" data-toggle="tooltip" data-placement="top" title="برداشتن">
                ...
                <div class="bg-gray p-4 rounded-rounded mt-40px">
                    ...
                    <ul class="generic-list-item pb-4">
                        ...
                        <li class="d-flex align-items-center justify-content-between font-weight-semi-bold">
                            ...
                            <span>{{number_format(App\Http\Controllers\Cart\Facades\Cart::price() - App\Http\Controllers\Cart\Facades\Cart::discount())}}  تومان </span>
                        </li>
                    </ul>
