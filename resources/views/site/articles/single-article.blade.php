                    ...
                    <div class="instructor-wrap py-5">
                        ...
                        <div class="media media-card">
                            <div class="media-img rounded-full avatar-lg mr-4">
                                <img src="{{ asset($article->user->image) }}" data-src="{{ asset($article->user->image) }}" alt="{{ $article->user->name }}" class="rounded-full lazy" />
                            </div>
                            <div class="media-body">
                                <h5> {{ $article->user->name }}</h5>
                                <span class="d-block lh-18 pt-2 pb-3"> شروع فعالیت از  {{ $article->user->created_at->diffForHumans() }} </span>
                            </div>
                        </div>
                    </div>
                    <!-- end instructor-wrap -->
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                ...
                                <div class="view-all-course-btn-box">
                                    <a href="{{ route('articles') }}" class="btn theme-btn w-100">مشاهده همه پست ها <i class="la la-arrow-left icon ml-1"></i></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item generic-list-item-boxed d-flex flex-wrap fs-15">
                                    @foreach($article->tags as $item)
                                        <li class="mr-2"><a href="{{ route('articles',['q' => $item->name]) }}">{{ $item->name }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
