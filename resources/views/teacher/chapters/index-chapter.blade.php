<div>
    ...
    <x-teacher.form-control link="{{ route('teacher.store.chapters',['create'] ) }}" confirmContent="تعریف فصل جدید"  title="فصل ها "/>
    <div class="card card-custom">
        <div class="card-body">
                        ...
                        <table  class="table table-striped table-bordered" id="kt_datatable">
                            ...
                            @forelse($chapters as $item)
                                <tr>
                                    ...
                                    <td>
                                        <x-admin.edit-btn href="{{ route('teacher.store.chapters',['edit', $item->id]) }}" />
                                    </td>
                                </tr>
                            @empty
            ...
            @endif
            {{$chapters->links('teacher.layouts.paginate')}}
        </div>
    </div>
