...
<head>
    <title>ورود به ناحه کاربری</title>
    <meta charset="utf-8">
                                    ...
                                    <table>
                                        <tr>
                                            <td valign="top" style="text-align: center; padding: 60px 0 10px 20px;">
                                                <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 30px; line-height: 36px; color: #ffffff; font-weight: bold;"> ورود به ناحیه کاربری</h1>
