        ...
        <div class="col-md-4  col-12">
            <div class="card card-custom gutter-b example example-compact ">
                <div class="row p-4">
                    ...
                    <x-admin.forms.dropdown id="category" :data="$data['category']" label="دسته*" wire:model.defer="category"/>
                    <x-admin.forms.dropdown id="quiz" :data="$data['quiz']" label="ازمون" wire:model.defer="quiz"/>
                    ...
                    <x-admin.forms.select2 id="poll_id" :data="$data['forms']" label="فرم نظر سنجی" wire:model.defer="poll_id"/>
                </div>
            </div>
        </div>
        <div class="col-12">
