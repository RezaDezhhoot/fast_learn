...
Route::prefix('admin')->middleware(['auth','role:admin'])->as('admin.')->group(function (){
    ...
    Route::prefix('polls')->group(function () {
        Route::get('',\App\Http\Controllers\Admin\Polls\IndexPoll::class)->name('poll');
        Route::get('/crud/{action}/{id?}',\App\Http\Controllers\Admin\Polls\StorePoll::class)->name('store.poll');
        Route::get('/report/{id}',\App\Http\Controllers\Admin\Polls\Report::class)->name('report.poll');
    });
