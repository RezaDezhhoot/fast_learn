        ...
        <div class="col-lg-7 mx-auto">
            <div class="error-content text-center">
                ...
                <div class="section-heading">
                    <h3 class="section__title pb-3">لطفا قبل از دسترسی به این بخش قبت نام نمایید</h3>
                </div>
                <div class="btn-box pt-30px">
                    <a href="{{ route('auth') }}" class="btn theme-btn"><i class="la la-reply mr-1"></i> قبت نام</a>
                </div>
            </div>
            <!-- end error-content -->
        </div>
