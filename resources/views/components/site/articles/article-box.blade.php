...
<div class="card card-item " {{ $attributes }}>
    <div class="card-image">
        <a href="{{ route('article',[$item['type'],$item['slug']]) }}" class="d-block">
    ...
    <div class="card-body">
        ...
        <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2">
            ...
            <li class="d-flex align-items-center"><a href="#">{{ $item->comments->count() }} نظر</a></li>
        </ul>
        <div class="d-flex justify-content-between align-items-center pt-3">
            <a href="{{ route('article',[$item['type'],$item['slug']]) }}" class="btn theme-btn theme-btn-sm theme-btn-white">ادامه مطلب <i class="la la-arrow-left icon ml-1"></i></a>
